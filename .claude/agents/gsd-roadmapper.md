...
Reference full template: `/home/toanak/workspace/localspeak/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/toanak/workspace/localspeak/.claude/get-shit-done/templates/state.md`.
