...
```bash
INIT=$(node "/home/toanak/workspace/localspeak/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/toanak/workspace/localspeak/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
