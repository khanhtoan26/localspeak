...
```bash
INIT=$(node "/home/toanak/workspace/localspeak/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/toanak/workspace/localspeak/.claude/get-shit-done/templates/spec.md.
